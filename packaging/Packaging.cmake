...
if(WIN32)
    ...
    # Keep NSIS's staging path below Windows' 260-character limit. The release
    # workflow restores the descriptive name after CPack creates the files.
    set(CPACK_PACKAGE_FILE_NAME "p")
    ...
    set(CPACK_NSIS_MUI_ICON "${PDFMERGE_PACKAGE_RESOURCES}/pdf-merge.ico")
    set(CPACK_NSIS_MUI_UNIICON "${PDFMERGE_PACKAGE_RESOURCES}/pdf-merge.ico")
